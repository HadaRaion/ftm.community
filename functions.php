...
function ftm_community_files()
{
    if (strstr($_SERVER['SERVER_NAME'], 'ftm-community.local')) {
        ...
        wp_enqueue_script('main-ftm_community-js', get_theme_file_uri('/bundled-assets/scripts.b0b06f6f440ef62011d8.js'), NULL, '1.0', true);
        wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.b0b06f6f440ef62011d8.css'));
      }
